			...
			do {//we still trying until we find a host or until we try all of them
				...
				try {				
					...
					if (result) { //if vm were succesfully created in the host
						Log.printLine("PolicyMINMIN: VM "+vm.getId()+ " host: "+host.getId() + " datacenter: "+vm.getHost().getDatacenter().getId());
						...
						String texto = "PolicyMINMIN: VM "+vm.getId()+ " host: "+host.getId()+" datacenter: "+vm.getHost().getDatacenter().getId() + "\n";
