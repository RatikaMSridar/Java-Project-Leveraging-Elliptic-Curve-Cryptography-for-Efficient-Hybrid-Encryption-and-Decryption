...
public class PerformenceCompare1 extends JFrame {
  ...
  //  db_conn db;
    ...
    public PerformenceCompare1() {
        ...
        try {
            ...
            Connection cn =DriverManager.getConnection("jdbc:mysql://localhost:3308/tracon_second","root","root");
                ...
                String qry = "SELECT Algorithmname,Throughput FROM tracon_second.tbl_performencecomparision t;;";
               
                testSet.executeQuery(qry);

               
                chart = ChartFactory.createBarChart("AlgorithmName (ECC and RSA)", "Metrics", "Throughput(mbps)  ",  testSet, PlotOrientation.VERTICAL, false, true, true);
    ...
    public static void main(String[] args) {
       ...
       PerformenceCompare1 pf = new PerformenceCompare1();
    }
}
